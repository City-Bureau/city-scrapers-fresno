...
class FresnoBicyclePedestrianSpider(CityScrapersSpider):
    ...
    def _parse_title(self, item):
        ...
        title = item.css(".rgMasterTable tbody tr td:nth-child(1) font font::text").get()
        return title
    ...
    def _parse_location(self, item):
        ...
        #location1 = item.css(".rgMasterTable tbody tr td:nth-child(5) font::text").get() 
        #location2 = item.css(".rgMasterTable tbody tr td:nth-child(5) font em::text").get()
        return {
            "address": "",
            "name": ""
        }
