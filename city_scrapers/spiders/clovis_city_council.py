...
class ClovisCityCouncilSpider(CityScrapersSpider):
    ...
    #start_urls = ["https://cityofclovis.com/government/city-council/city-council-agendas/"]
    ...
    def _parse_start(self, item):
        ...
        time = re.search('(.+?) ', startTime).group(1)
        ...
        #date = re.search('([0-9]/[0-9]/[0-9]{4})', startDate.strip()).group(0)
