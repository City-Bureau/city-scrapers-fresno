...
def test_title():
    ...
    assert (
        parsed_items[1]["title"] == "City Council 2022: September 20, 2022\xa0 Agenda"
    )
    assert (
        parsed_items[2]["title"]
        == "City Council 2022: September 6, 2022 City Council Meeting Cancelled"
    )
    ...
    assert (
        parsed_items[5]["title"]
        == "City Council 2022: July 25, 2022\xa0 Special Meeting Agenda"
    )
...
def test_time_notes(item):
    assert item["time_notes"] == (
        "Meetings regularly take place at "
...
def test_id():
    assert parsed_items[0]["id"] == (
        "fre_fowler_city_council/202210041900/x/"
        "city_council_2022_october_4_2022_agenda"
    )
    assert parsed_items[1]["id"] == (
        "fre_fowler_city_council/202209201900/x/"
        "city_council_2022_september_20_2022_agenda"
    )
    assert parsed_items[2]["id"] == (
        "fre_fowler_city_council/202209061900/x/"
        "city_council_2022_september_6_2022_city_council_meeting"
    )
    assert parsed_items[3]["id"] == (
        "fre_fowler_city_council/202208161900/x/"
        "city_council_2022_august_16_2022_agenda"
    )
    assert parsed_items[4]["id"] == (
        "fre_fowler_city_council/202208021900/x/"
        "city_council_2022_august_2_2022_agenda"
    )
    assert parsed_items[5]["id"] == (
        "fre_fowler_city_council/202207251900/x/"
        "city_council_2022_july_25_2022_special_meeting_agenda"
    )
    assert parsed_items[6]["id"] == (
        "fre_fowler_city_council/202207191900/x/"
        "city_council_2022_july_19_2022_agenda"
    )
...
def test_links():
    assert parsed_items[0]["links"] == [
        {
            "href": (
                "https://fowlercity.org/wp-content/uploads/2022/"
                "09/FCC-Agenda-10042022.pdf"
            ),
